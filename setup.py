...
setuptools.setup(
        ...
        data_files=[('ascii-telnet-server/movies',
                     ['ascii_theater/sample_movies/rick_roll.txt',
                      'ascii_theater/sample_movies/sw1.txt',
                      'ascii_theater/sample_movies/short_intro.txt', ])],
